...
session_start();
require '../config.php';
require 'Admin-PanelPHPMailer-master\src\Exception.php';
require 'Admin-PanelPHPMailer-master\src\PHPMailer.php';
require 'Admin-PanelPHPMailer-master\src\SMTP.php';
